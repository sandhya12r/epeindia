    ...
    <Splide aria-label="My Favorite Images">
      <SplideSlide>
        <div className="bg-banner-2 w-screen h-[700px] bg-center bg-opacity-50 capitalize">
          <div className="text-xl text-white font-medium flex gap-5 flex-col backdrop-brightness-50 w-full h-full justify-center items-center">
            ...
            <div className="flex items-center flex-col gap-8 mt-5">
              <button className="btn btn-banner rounded-full">Enquire Now</button>
