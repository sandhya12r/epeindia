  ...
  return (
    <div className='container mx-auto py-10 flex flex-col items-center justify-center'>
        ...
        <form className='border-black border-2 flex flex-col max-w-3xl w-full shadow-sm px-12 py-10 gap-4'>
            ...
            <input type='email' className='border border-black border-1 w-full px-3 py-2 bg-white' placeholder='Email Address *' required/>
            <input type='date' className='border border-black border-1 w-full px-3 py-2 bg-white uppercase' placeholder='Date'/>
            <select type='text' className='border border-black border-1 w-full px-3 py-2 bg-white uppercase' placeholder='Suitable Time Slot'>
